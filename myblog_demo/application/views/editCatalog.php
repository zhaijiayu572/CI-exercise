...
<head>
    ...
    <title>博客设置/分类管理 <?php echo $this->session->uname?>的博客 - SYSIT个人博客</title>
...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Topbar">
        <div id="VisitorInfo">
            当前访客身份：
            <?php echo $this->session->uname?> [ <a href="#">退出</a> ]
        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="Catalog/do_editcatalog"
                          method="post">
                        <h3> 修改博客分类 </h3>
                        <div id="error_msg" class="error_msg" style="display:none;"></div>
                        <input type="hidden" name="cid" value="<?echo $cid ?>">
                        <label>分类名称:</label><input id="txt_link_name" name="name" value="<?php echo $cname?>" size="15" tabindex="1"
                                                   type="text">
                        <label>排序值:</label><input name="sort_order" value="<?php echo $cid?>" size="3" type="text">
                        <span class="submit">
