...
<div id="OSC_Screen">
    <div id="OSC_Content" class="CenterDiv">
        ...
        <div class="MainForm" id="reg_page">
            <form id="frm_reg" action="index.php/User/do_reg" method="POST" style="float:left; width:620px;">
                <h2>申请<span style="color: #006600;"> SYSIT Blog</span> 账号，已经申请的请点击<a href="login.php">这里</a>登录</h2>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th>&nbsp;</th>
                        <td>
                            <img id="img_vcode" alt="..." src="images/captcha.png"
