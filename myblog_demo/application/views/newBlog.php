...
<head>
    ...
    <title>发表博客 <?php echo $this->session->uname?>的博客 - SYSIT个人博客</title>
            ...
            <div id="AdminMenu">
                ...
                <ul>
                    <li class="caption">博客管理
                        <ol>
                            <li class="current"><a href="newBlog.php">发表博客</a></li>
                            <li><a href="blogCatalogs.php">博客设置/分类管理</a></li>
...
<!--                                        <option value="92336">转贴的文章</option>-->
                                    ...
                                    <a href="Catalog/add_catalog" onclick="return confirm('是否放弃当前编辑进入分类管理？');">分类管理»</a>
                                </td>
                            </tr>
                            <tr>
                                <td class='t'>内容（必填）
