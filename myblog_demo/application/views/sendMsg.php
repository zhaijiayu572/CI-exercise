...
<div id="OSC_Banner">
    <div id="OSC_Slogon"><?php echo $this->session->uname?>'s Blog</div>
    <div id="OSC_Channels">
        <ul>
...
<form id="frm_sendmsg" action="Message/do_add_message" method="POST">
...
<div class="CommentForm">
	<form id="form_inline_comment" action="Message/do_add_message" method="POST">
